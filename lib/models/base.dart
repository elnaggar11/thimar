...
import 'package:thimar/core/utils/logger.dart';
...
abstract class Model {
  ...
  @override
  bool operator ==(other) {
    return other is Model && other.id == id && id.isNotEmpty;
  }
  ...
  int? intNullFromJson(dynamic json, String attribute, {int? defaultValue}) {
    try {
      if (json == null || json[attribute] == null) {
        return defaultValue;
      } else {
  ...
  num numFromJson(
    ...
    try {
      if (json == null || json[attribute] == null) {
        ...
        return num.parse(
          (num.tryParse(json[attribute].toString()) ?? json[attribute])
              .toStringAsFixed(fix),
        );
      } else {
        return num.parse(
