...
class LoggerDebug {
  ...
  void black(String message, [String? title]) => log(
    "${LogColors.black}$message${LogColors.reset}",
    name: "$headColor${title ?? constTitle ?? ""}${LogColors.reset}",
  );

  void white(String message, [String? title]) => log(
    "${LogColors.white}$message${LogColors.reset}",
    name: "$headColor${title ?? constTitle ?? ""}${LogColors.reset}",
  );

  void red(String message, [String? title]) => log(
    "${LogColors.red}$message${LogColors.reset}",
    name: "\"$headColor${title ?? constTitle ?? ""}${LogColors.reset}\"",
  );

  void green(String message, [String? title]) => log(
    "${LogColors.green}$message${LogColors.reset}",
    name: "$headColor${title ?? constTitle ?? ""}${LogColors.reset}",
  );

  void yellow(String message, [String? title]) => log(
    "${LogColors.yellow}$message${LogColors.reset}",
    name: "$headColor${title ?? constTitle ?? ""}${LogColors.reset}",
  );

  void blue(String message, [String? title]) => log(
    "${LogColors.blue}$message${LogColors.reset}",
    name: "$headColor${title ?? constTitle ?? ""}${LogColors.reset}",
  );

  void cyan(String message, [String? title]) => log(
